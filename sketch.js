...
function preload(){
  ...
  obstacle1 = loadAnimation("obstacle1.jpg","obstacle3.jpg","obstacle5.jpg","obstacle6.jpg","obstacle7.jpg");
  obstacle2 = loadAnimation("obstacle8.jpg","obstacle9.jpg","obstacle10.jpg","obstacle11.jpg","obstacle12.jpg")
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    ...
    switch(rand) {
      case 1: obstacle.addAnimation(obstacle1);
              break;
      case 2: obstacle.addAnimation(obstacle2);
              break;
      default: break;
    }
